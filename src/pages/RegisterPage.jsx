...
const RegisterPage = () => {
  ...
  const onSubmit = async (e) => {
    ...
    if (!agreedToTerms) {
      setError(t("registerPage.termsRequired"));
      setLoading(false);
      return;
    }
        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="reg-first-name" className="block text-sm text-gray-700 dark:text-gray-300 mb-1.5">
              ...
              <div>
                <label htmlFor="reg-last-name" className="block text-sm text-gray-700 dark:text-gray-300 mb-1.5">
            ...
            <div>
              <label htmlFor="reg-username" className="block text-sm text-gray-700 dark:text-gray-300 mb-1.5">
            ...
            <div>
              <label htmlFor="reg-password" className="block text-sm text-gray-700 dark:text-gray-300 mb-1.5">
            ...
            <div>
              <label htmlFor="reg-confirm" className="block text-sm text-gray-700 dark:text-gray-300 mb-1.5">
            ...
            <label className="flex items-start gap-3 text-sm text-gray-600 dark:text-gray-400 cursor-pointer">
              ...
              />
              <span>{t("registerPage.termsAgree")}</span>
            </label>
            ...
            {success && (
              <p className="text-sm text-green-700 dark:text-green-400 bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-900 rounded-xl px-3 py-2">
                {success}
              </p>
            )}
          ...
          <p className="text-sm text-gray-500 dark:text-gray-500 mt-8">{t("registerPage.subtitle")}</p>
        </div>
      </div>
